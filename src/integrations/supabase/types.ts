  ...
  public: {
    Tables: {
      ...
      coordination_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "coordination_notes_author_token_id_fkey"
            columns: ["author_token_id"]
            isOneToOne: false
            referencedRelation: "ngo_access_tokens"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      medication_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "medication_requests_pharmacy_id_fkey"
            columns: ["pharmacy_id"]
            isOneToOne: false
      ...
      pharmacies: {
        Row: {
          address: string | null
          available_medications: string[] | null
          created_at: string
          created_by: string | null
          id: string
          is_operational: boolean
